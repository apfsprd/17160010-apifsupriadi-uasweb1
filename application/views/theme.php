...
<head>
    ...
    <!-- This page CSS -->
    <!-- chartist CSS -->
    <link href="<?= base_url(); ?>assets/assets/node_modules/morrisjs/morris.css" rel="stylesheet">
    <!--Toaster Popup message CSS -->
    <link href="<?= base_url(); ?>assets/assets/node_modules/toast-master/css/jquery.toast.css" rel="stylesheet">
    <!-- Custom CSS -->
...
<body class="skin-default fixed-layout">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <div class="user-pro-body">
                        <div><img src="<?= base_url(); ?>assets/assets/images/users/2.jpg" alt="user-img" class="img-circle"></div>
                        <div class="dropdown">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="<?= base_url(); ?>assets/documentation/documentation.html" aria-expanded="false"><i class="fa fa-circle-o text-danger"></i><span class="hide-menu">Documentation</span></a></li>
    ...
    <!-- ============================================================== -->
    <!--morris JavaScript -->
    <script src="<?= base_url(); ?>assets/assets/node_modules/raphael/raphael-min.js"></script>
    <script src="<?= base_url(); ?>assets/assets/node_modules/morrisjs/morris.min.js"></script>
    <script src="<?= base_url(); ?>assets/assets/node_modules/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!-- Popup message jquery -->
    <script src="<?= base_url(); ?>assets/assets/node_modules/toast-master/js/jquery.toast.js"></script>
    <!-- Chart JS -->
